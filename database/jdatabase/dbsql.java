package jdatabase;
	...
	{  
		...
		static String databasepassword = "system";
		...
		*/
		...
		public static void initializedatabase(int databaseID)
		{
			...
			try
			{
				String dbConfigFileName = "C:\\Cloud\\database\\dbconfig_customer.json";
				
				if (databaseID == 0)
					dbConfigFileName = "C:\\Cloud\\database\\dbconfig_customer.json";
				else if (databaseID == 1)
					dbConfigFileName = "C:\\Cloud\\database\\dbconfig_account.json";
				else if (databaseID == 2)
					dbConfigFileName = "C:\\Cloud\\database\\dbconfig_moneytransfer.json";
				else if (databaseID == 3)
					dbConfigFileName = "C:\\Cloud\\database\\dbconfig_eventsync.json";
